...
extern uint32_t SWL_MASK[4];
extern int32_t SWL_SHIFT[4];

extern uint32_t SWR_MASK[4];
extern int32_t SWR_SHIFT[4];

extern uint32_t LWL_MASK[4];
extern int32_t LWL_SHIFT[4];

extern uint32_t LWR_MASK[4];
extern int32_t LWR_SHIFT[4];

extern int32_t RoundingModel;
#endif /* _INTERPRETER_OPS_H_ */
