...
void fpuStoreDwordFromX86Reg(int32_t * StackPos, int32_t x86Reg,
			     uint32_t pop);
void fpuStoreDwordToN64Mem(int32_t * StackPos, int32_t x86reg,
			   uint32_t Pop);
void fpuStoreIntegerDword(int32_t * StackPos, void *Variable,
			  uint32_t pop);
void fpuStoreIntegerDwordFromX86Reg(int32_t * StackPos, int32_t x86Reg,
				    uint32_t pop);
void fpuStoreIntegerQword(int32_t * StackPos, void *Variable,
			  uint32_t pop);
void fpuStoreIntegerQwordFromX86Reg(int32_t * StackPos, int32_t x86Reg,
				    uint32_t pop);
void fpuStoreQword(int32_t * StackPos, void *Variable, uint32_t pop);
void fpuStoreQwordFromX86Reg(int32_t * StackPos, int32_t x86Reg,
			     uint32_t pop);
